...
Plugins can declare arguments on launcher commands (lorem ipsum: count + unit). Users can assign a global shortcut to any command in Settings, the same way  does.
