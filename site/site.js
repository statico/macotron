const CARDS = [
  ...
  ["Display", [
    ...
    ["CRT overlay", "Scanlines, phosphor grille, rolling bar."],
  ...
  ["System", [
    ...
    ["Memory", "Total, used, free, and pressure."],
    ...
    ["Time zones", "Format the time in any IANA zone."],
  ...
  ["Featured plugins", [
    ...
    ["File Search", "Macotron's own file index in the launcher."],
    ["Lock Screen", "Lock this Mac from the launcher."],
    ["Meetings", "Next calendar event in the menu bar."],
    ["Mini Calendar", "Weekday and date in the bar, month in its menu."],
  ...
  ["More plugins", [
    ...
    ["Browser Picker", "Route links by host or pattern; unknown hosts prompt."],
    ...
    ["Park Webcam", "A live Yellowstone camera in the menu bar."],
...
const APIS = [
  ["macotron.window", [
    ...
    "flash() an outline to show the focus",
  ...
  ["macotron.display", [
    ...
    "CRT overlay: scanlines, rolling bar",
    "display:changed flags",
  ]],
  ["macotron.system", [
    "CPU, GPU, memory, disk, processes",
    "Fan RPM and a 50% or 100% floor",
  ...
  ["macotron.network", [
    ...
    "setWifi / setBluetooth / setAirDrop",
  ...
  ["macotron.files", [
    ...
    "configure roots, search, status, reindex",
  ]],
  ["macotron.shell", ["Runs a command through /bin/zsh", "Not gated: no allowlist, no prompt"]],
  ...
  ["macotron.menubar", [
    ...
    "isVisible / isDark, menubar:appearance",
  ]],
  ...
  ["macotron.homekit", ["Stub: no public HomeKit on native macOS", "homes() and accessories() are empty"]],
  ...
  ["macotron.launcher", ["Inject extra launcher rows", "query() answers each keystroke"]],
  ["macotron.usb", ["List devices; usb:changed"]],
  ["macotron.shortcuts", ["List and run Shortcuts.app"]],
  ["macotron.url", ["Custom schemes; open in an app or profile", "setDefaultHandler, onFallback for misses"]],
  ["macotron.keychain", ["get, set, delete, has"]],
  ["macotron.idle", ["Seconds idle; threshold; idle/active events"]],
  ["macotron.command", [
    "Register a launcher command",
    "Text, number, and dropdown arguments",
  ]],
  ["macotron.plugin", ["Metadata, permissions, typed options", "Password options live in the Keychain"]],
  ["macotron.on / off", ["Subscribe to host events"]],
