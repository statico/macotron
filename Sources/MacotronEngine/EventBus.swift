...
public final class EventBus {
    ...
    public func emit(
        ...
        // -- and off() releases the callback. A reload releases every callback
        // too. Hold a reference to each one for the length of the loop so that
        // frees nothing still to be called.
