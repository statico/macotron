...
public final class SnippetsModule: NativeModule {
    ...
    public func register(in engine: Engine, options: [String: Any]) {
        ...
        JSBridge.fn(ctx, snippets, "list", 0) { ctx, _, _, _ in
        ...
        JSBridge.fn(ctx, snippets, "set", 2) { ctx, _, argc, argv in
        ...
        JSBridge.fn(ctx, snippets, "remove", 1) { ctx, _, argc, argv in
        ...
        JSBridge.fn(ctx, snippets, "insert", 1) { ctx, _, argc, argv in
            guard let ctx, let argv, argc >= 1, let module = module(ctx),
                  let abbr = JSBridge.toString(ctx, argv[0]),
        ...
        JSBridge.fn(ctx, snippets, "setExpansionEnabled", 1) { ctx, _, argc, argv in
        ...
        JSBridge.fn(ctx, snippets, "isExpansionEnabled", 0) { ctx, _, _, _ in
